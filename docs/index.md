...
- [百度智能搜索](https://chat.baidu.com/)
- [Kimi](https://www.kimi.com/)

## 基础

- [Visual Studio Code](https://vscode.js.cn/docs)
...
- [JSPM](https://jspm.org/)
- [Iconify Designd](https://iconify.design/)
...
- [@microsoft/signalr](https://github.com/dotnet/aspnetcore/)
...
- [TDesign Vue Next for Web](https://tdesign.tencent.com/vue-next/overview)
- [TDesign Vue Next for Mobile](https://tdesign.tencent.com/mobile-vue/)
...
- 官方文档
  ...
  - [Microsoft Learn](https://learn.microsoft.com/zh-cn/docs/)
  - [.NET 架构](https://learn.microsoft.com/zh-cn/dotnet/architecture/)
  - [.Net Docs](https://docs.microsoft.com/zh-cn/dotnet/)
  - [Asp.NET Core](https://learn.microsoft.com/zh-cn/aspnet/core/)
  - [Entity Framework](https://learn.microsoft.com/zh-cn/ef/)
  - [Windows Forms](https://learn.microsoft.com/zh-cn/dotnet/desktop/winforms/)
  - [WPF](https://learn.microsoft.com/zh-cn/dotnet/desktop/wpf/)
  - [MAUI](https://learn.microsoft.com/zh-cn/dotnet/maui/)
  - [IoT](https://learn.microsoft.com/zh-cn/dotnet/iot/)
  - [ML.NET](https://learn.microsoft.com/zh-cn/dotnet/machine-learning/)
  - [.NET for Apache® Spark™](https://learn.microsoft.com/zh-cn/previous-versions/dotnet/spark/what-is-spark)
  - [游戏开发](https://visualstudio.microsoft.com/zh-hans/vs/features/game-development/)
...
- 类库
  ...
  - [Microsoft.Extensions.FileProviders.Embedded](https://www.nuget.org/packages/Microsoft.Extensions.FileProviders.Embedded)
  ...
  - [OrchardCore.Localization.Core](https://www.nuget.org/packages/OrchardCore.Localization.Core)
  ...
  - [Minio](https://www.nuget.org/packages/Minio)
  ...
  - [ValueInjecter](https://www.nuget.org/packages/ValueInjecter)
  - [Z.Expressions.Eval](https://www.nuget.org/packages/Z.Expressions.Eval)
  ...
  - [HttpClientToCurl](https://www.nuget.org/packages/HttpClientToCurl)
  - [InfluxDB.Client.Core](https://www.nuget.org/packages/InfluxDB.Client.Core)
  - [OpenTelemetry](https://www.nuget.org/packages/OpenTelemetry)
  - [prometheus-net.AspNetCore](https://www.nuget.org/packages/prometheus-net.AspNetCore)
  - [HealthChecks.OpenTelemetry.Instrumentation](https://www.nuget.org/packages/HealthChecks.OpenTelemetry.Instrumentation)
  - [DateOnlyTimeOnly.AspNetCore](https://www.nuget.org/packages/DateOnlyTimeOnly.AspNetCore)
  - [MessagePack](https://www.nuget.org/packages/MessagePack)
  - [Kveer.XmlRPC](https://www.nuget.org/packages/Kveer.XmlRPC)
  - [IoTClient](https://www.nuget.org/packages/IoTClient)
  - [Microsoft.Web.WebView2](https://www.nuget.org/packages/Microsoft.Web.WebView2)
  - [MiniProfiler](https://www.nuget.org/packages/MiniProfiler)
  - [nulastudio.NetCoreBeauty](https://www.nuget.org/packages/nulastudio.NetCoreBeauty)
  - [System.Runtime.WindowsRuntime](https://www.nuget.org/packages/System.Runtime.WindowsRuntime)
...
- 开源项目
  ...
  - [Polaris Mesh](https://github.com/polarismesh/polaris)
